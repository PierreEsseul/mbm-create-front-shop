...
const BtnLoad = () => {
  const buttonArea = useRef('.btn-area')
  const progressArea = useRef('.progress-area')
  const completeArea = useRef('.complete-area')
  const mainBtn = useRef('.main-btn rect')
  const frameBtn = useRef('.frame-btn rect')
  const loadingIcon = useRef('.progress-area .area-left svg')
  const loadingProgress = useRef('.progress-area .area-left span')
  const loadingBtn = useRef('.progress-area .area-right')
  const tick1 = useRef('.complete-area .tick-1')
  const tick2 = useRef('.complete-area .tick-2')
  const doneText = useRef('.complete-area span')
      ...
      <main className='main'>
          <div className="btn-area">
              <svg className="main-btn" xmlns="http://www.w3.org/2000/svg" version="1.1">
                  <rect fill="#fff" stroke="#ffbf23" strokeWidth="2" x="1" y="1" rx="10" ry="10" />
              </svg>

              <svg className="frame-btn" xmlns="http://www.w3.org/2000/svg" version="1.1">
                  <rect fill="none" stroke="#ffbf23" strokeWidth="2" strokeDasharray="525" strokeDashoffset="525" x="1" y="1" rx="10" ry="10" />
              </svg>
              ...
              <div className="complete-area">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 52.71 28.57">
                      <path className="tick-1" fill="none" stroke="#ffff" strokeDasharray="52" strokeDashoffset="52" d="M2,12.42,16.14,26.57,34.71,2" />
                      <path className="tick-2" fill="none" stroke="#fff8" strokeDasharray="52" strokeDashoffset="52" d="M18,12.42,32.14,26.57,50.71,2" />
                  </svg>
